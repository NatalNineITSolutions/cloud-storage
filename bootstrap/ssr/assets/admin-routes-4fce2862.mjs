...
import { u as useSettings, C as CustomMenu, T as Trans, m as message, a as apiClient, b as useIsMobileMediaQuery, c as useNumberFormatter, I as Item, d as IconButton, e as createSvgIcon, A as ArrowDropDownIcon, f as useDialogContext, D as Dialog, g as DialogHeader, h as DialogBody, F as Form$1, i as Checkbox, B as Button, j as DialogTrigger, k as useTrans, l as TextField, S as SearchIcon, o as opacityAnimation, n as Skeleton, P as ProgressBar, p as StaticPageTitle, q as queryClient, t as toast, s as showHttpErrorToast, r as ConfirmationDialog, v as IllustratedMessage, w as SvgImage, x as DialogFooter, y as onFormQueryError, z as FormTextField, E as CheckIcon, G as CloseIcon, H as Chip, J as Tooltip, M as MixedText, K as FileUploadProvider, L as useAppearanceEditorMode, N as ProgressCircle, O as ButtonBase, Q as useValueLists, R as List, U as ListItem, V as clamp, W as createSvgIconFromTree, X as DoneAllIcon, Y as Section, Z as useNavigate$1, _ as FormImageSelector, $ as useBootstrapData, a0 as LinkStyle, a1 as SiteConfigContext, a2 as getBootstrapData, a3 as MenuTrigger, a4 as Menu, a5 as getInputFieldClassNames, a6 as FormRadioGroup, a7 as FormRadio, a8 as prettyBytes, a9 as useSocialLogin, aa as ExternalLink, ab as useField, ac as Field, ad as useResendVerificationEmail, ae as useUser, af as FullPageLoader, ag as useUploadAvatar, ah as useRemoveAvatar, ai as FileTypeIcon, aj as useProducts, ak as FormattedPrice, al as useActiveUpload, am as UploadInputType, an as Disk, ao as WarningIcon, ap as KeyboardArrowDownIcon, aq as useCustomPage, ar as PageMetaTags, as as PageStatus, at as useCollator, au as loadFonts, av as AuthRoute, aw as NotFoundPage } from "../server-entry.mjs";
import { D as DashboardLayout, a as DashboardNavbar, b as DashboardSidenav, c as DashboardContent, F as FilterOperator, d as FilterControlType, e as createdAtFilter, u as updatedAtFilter, S as SelectForwardRef, K as KeyboardArrowLeftIcon, f as KeyboardArrowRightIcon, g as useBackendFilterUrlParams, I as InputFilterPanel, N as NormalizedModelFilterPanel, h as DateRangeFilterPanel, C as ChipFieldFilterPanel, i as SelectFilterPanel, B as BackendFiltersUrlKey, j as FilterList$1, T as Table, A as AddIcon, k as downloadFileFromUrl, l as FileDownloadIcon, m as Avatar, n as FormDatePicker, o as FormSwitch, p as ChipList, q as useDraggable, r as useDroppable, s as updateRects, t as droppables, v as FormChipField, w as DeleteIcon, x as Switch, y as FormSelect, U as USER_MODEL, M as MoreVertIcon, z as ChipField, E as useNormalizedModels, G as FILE_ENTRY_INDEX_FILTERS, H as FilePreviewDialog, J as timestampFilter, L as FormNormalizedModelField, O as LinkIcon, P as UnfoldMoreIcon, Q as ArrowBackIcon } from "./UnfoldMore-58946905.mjs";
...
import { F as FormattedDate, E as EditIcon, B as Breadcrumb, a as BreadcrumbItem } from "./Edit-e1a3fcfd.mjs";
...
const IconList = React.lazy(() => import("./icon-list-4703e86d.mjs"));
...
const AceEditor = React.lazy(() => import("./ace-editor-868bf8c5.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(
      FormSelect,
      {
        ...
        children: homepage.options.map((option) => /* @__PURE__ */ jsx(Item, { value: option.value, children: /* @__PURE__ */ jsx(Trans, { ...option.label }) }, option.value))
      }
    ),
    (_a = data == null ? void 0 : data.menuItemCategories) == null ? void 0 : _a.map((category) => {
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-0456531b.mjs")
);
...
const ReportsPage = React.lazy(() => import("./admin-report-page-807cbebb.mjs"));
...
//# sourceMappingURL=admin-routes-4fce2862.mjs.map
