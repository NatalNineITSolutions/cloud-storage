...
import { aC as getFromLocalStorage, aD as setInLocalStorage, aE as DriveQueryKeys, a7 as getBootstrapData, c as apiClient, w as showHttpErrorToast, m as message, t as queryClient, v as toast, O as useAuth, a8 as MenuTrigger, f as IconButton, au as KeyboardArrowDownIcon, a9 as Menu, I as Item, T as Trans, N as Tooltip, B as Button, d as useIsMobileMediaQuery, aF as Navbar$2, an as FileTypeIcon, o as useTrans, z as SvgImage, aG as secureFilesSvg, p as TextField, aH as invalidateEntryQueries, aI as getAxiosErrorMessage, aJ as driveState, aK as useDriveStore, aL as TrashPage, aM as SharesPage, aN as CreateNewFolderIcon, aO as useDriveUploadQueue, aP as FileUploadIcon, aQ as openUploadWindow, aR as DriveFolderUploadIcon, aS as RootFolderPage, ad as prettyBytes, M as FormattedDate, l as Checkbox, V as ProgressCircle, aT as AdHost, q as opacityAnimation, n as DialogTrigger, a1 as Section, D as DashboardLayout, a as DashboardNavbar, R as FileUploadProvider, y as IllustratedMessage, aU as shareSvg, aB as NotFoundPage, aV as WorkspaceQueryKeys, G as onFormQueryError, h as useDialogContext, i as Dialog, j as DialogHeader, k as DialogBody, F as Form, H as FormTextField, E as DialogFooter, aW as useActiveWorkspaceId, aX as PersonalWorkspace, x as ConfirmationDialog, X as useValueLists, aY as ExitToAppIcon, K as CloseIcon, aZ as useUserWorkspaces, a_ as openDialog, a$ as createEventHandler, a2 as useNavigate$1, b0 as getPathForFolder, b1 as CustomMenuItem, C as CustomMenu, u as useSettings, b2 as useIsDarkMode, b3 as MenuIcon, b4 as Logo, b5 as StorageMeter, b6 as shallowEqual, b7 as makeFolderPage, b8 as SearchPage, b9 as DashboardLayoutContext, S as SearchIcon, ba as ContextMenu, bb as useMediaQuery, bc as useActiveWorkspace, Q as MixedText, W as ButtonBase, bd as CreateNewButton, be as useFileUploadStore, bf as ErrorIcon, at as WarningIcon, bg as CheckCircleIcon, a6 as SiteConfigContext, bh as useActiveDialogEntry, bi as useListbox, bj as Listbox, bk as Popover, bl as useListboxKeyboardNavigation, Y as List, Z as ListItem, bm as DRIVE_PAGES, bn as makePartialFolderPage, s as StaticPageTitle, b as DashboardSidenav, bo as NavbarSearch, aA as AuthRoute } from "../server-entry.mjs";
import { create } from "zustand";
import { immer } from "zustand/middleware/immer";
import React, { Fragment, useState, createElement, useContext, useRef, useEffect, createContext, cloneElement, forwardRef, useMemo, useLayoutEffect, useCallback, memo, useId } from "react";
import { J as useFileEntryUrls, h as downloadFileFromUrl, i as FileDownloadIcon, O as FileThumbnail, L as LinkIcon, s as DeleteIcon, P as TableContext, M as MoreVertIcon, T as Table, z as FilePreviewDialog, D as DashboardContent, Q as FilePreviewContainer, R as FileEntryUrlsContext, w as ChipField, A as ArrowDropDownIcon, o as useDroppable, n as useDraggable, V as FILE_ENTRY_TYPE_FILTER, F as FilterOperator, a as FilterControlType, c as createdAtFilter, u as updatedAtFilter, g as FilterList, q as droppables, W as usePointerEvents, p as updateRects, X as activeInteraction, Y as isCtrlOrShiftPressed, Z as isCtrlKeyPressed, j as Avatar, x as useNormalizedModels, t as Switch, l as FormSwitch, k as FormDatePicker, _ as ComboboxEndAdornment, H as ArrowBackIcon, $ as dragMonitors } from "./ArrowBack-ac331367.mjs";
import { I as ImportExportIcon, R as RemoveRedEyeIcon, P as PersonAddIcon, S as StarIcon, a as StarOutlineIcon, D as DriveFileMoveIcon, b as DriveFileRenameOutlineIcon, C as ContentCopyIcon, c as RestoreIcon, d as DeleteForeverIcon, e as SortIcon, G as GridViewIcon, f as GroupIcon, A as ArrowRightIcon, B as BackupIcon, F as FolderIcon, g as GroupsIcon, V as ViewModuleIcon, h as ViewListIcon, i as InfoIcon } from "./Info-80dbd416.mjs";
import { AnimatePresence, m } from "framer-motion";
import clsx from "clsx";
import memoize from "nano-memoize";
import { B as Breadcrumb, a as BreadcrumbItem, E as EditIcon, C as ChevronRightIcon } from "./Edit-19a60eb6.mjs";
import "react-dom";
...
function useShareableLinkPage() {
  ...
  const query = useInfiniteQuery({
    ...
    initialData: () => {
      var _a2, _b2;
      const data = (_a2 = getBootstrapData().loaders) == null ? void 0 : _a2.shareableLinkPage;
      if (data && ((_b2 = data.link) == null ? void 0 : _b2.hash) === hash) {
  ...
  return {
    ...query,
    link: (_a = query.data) == null ? void 0 : _a.pages[0].link,
    entries: (_b = query.data) == null ? void 0 : _b.pages.flatMap((p) => {
      var _a2;
      return (_a2 = p.folderChildren) == null ? void 0 : _a2.data;
    })
  };
}
...
function ShareableLinkPageActionButtons() {
  ...
  const alreadyImported = (_a = link == null ? void 0 : link.entry) == null ? void 0 : _a.users.find((u) => u.id === (user == null ? void 0 : user.id));
...
function useAddToStarredAction(entries) {
  ...
  if (entries.every((e) => {
    var _a;
    return (_a = e.tags) == null ? void 0 : _a.find((tag) => tag.name === "starred");
...
function buildFolderHash(link, folderHash) {
  var _a;
  let hash = link.hash;
  if (folderHash && ((_a = link.entry) == null ? void 0 : _a.hash) !== folderHash) {
...
function ShareableLinkPage() {
  ...
  } else if (((_a = link == null ? void 0 : link.entry) == null ? void 0 : _a.type) === "folder") {
...
function WorkspaceMembersDialog({
  ...
  return /* @__PURE__ */ jsxs(Dialog, { size: "lg", children: [
    ...
    /* @__PURE__ */ jsx(DialogBody, { children: isLoading ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center min-h-[238px]", children: /* @__PURE__ */ jsx(ProgressCircle, { isIndeterminate: true, "aria-label": "Loading workspace..." }) }) : /* @__PURE__ */ jsx(Manager, { workspace: data.workspace }) })
  ] });
}
function Manager({ workspace }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-10 mb-14 text-base", children: [
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: members.map((member) => /* @__PURE__ */ jsx(
      MemberListItem$1,
      {
        workspace,
        member
  ...
  return /* @__PURE__ */ jsxs(
    m.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:flex flex-auto items-center justify-between gap-14 min-w-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "overflow-hidden mb-10 md:mb-0 md:mr-10", children: [
...
function usePermissions(workspace) {
  ...
  const authMember = (_a = workspace.members) == null ? void 0 : _a.find((mb) => mb.id === (authUser == null ? void 0 : authUser.id));
  if (authMember) {
    permissions.forEach((permission) => {
      var _a2;
      response[permission] = authMember.is_owner || !!((_a2 = authMember.permissions) == null ? void 0 : _a2.find(
...
function MemberActions({ workspace, member }) {
  ...
  const roleSelector = !can.update || isOwner || isCurrentUser ? /* @__PURE__ */ jsx("div", { className: "text-muted ml-auto first:capitalize", children: /* @__PURE__ */ jsx(Trans, { message: member.role_name }) }) : /* @__PURE__ */ jsx(
    RoleMenuTrigger,
    {
...
function InviteChipField({ workspace }) {
  ...
  useEffect(() => {
    var _a;
    if (!selectedRole && ((_a = data == null ? void 0 : data.workspaceRoles) == null ? void 0 : _a.length)) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-30", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-14 justify-between mt-14", children: [
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      ...
      body: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "font-semibold mt-8", children: /* @__PURE__ */ jsx(
          Trans,
          {
...
function RoleMenuTrigger({
  ...
  var _a;
  const { data } = useValueLists(["workspaceRoles"]);
  const role = (_a = data == null ? void 0 : data.workspaceRoles) == null ? void 0 : _a.find((r) => r.id === value);
...
function WorkspaceSelector({
  ...
  const { workspaceId, setWorkspaceId } = useActiveWorkspaceId();
  const activeWorkspace = workspaces == null ? void 0 : workspaces.find((w) => w.id === workspaceId);
  ...
  if (!activeWorkspace || !hasPermission("workspaces.create") && (workspaces == null ? void 0 : workspaces.length) === 1) {
    return null;
  }
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: clsx("workspace-selector", className), children: /* @__PURE__ */ jsxs("div", { className: "workspace-list flex flex-wrap gap-10 mx-36 justify-between", children: [
    /* @__PURE__ */ jsx(WorkspaceAddNewButton, { onChange }),
    workspaces == null ? void 0 : workspaces.map((workspace) => /* @__PURE__ */ jsx(
      WorkspaceItem,
      {
        workspace,
        onChange,
...
function WorkspaceAddNewButton({ onChange }) {
  const { setWorkspaceId } = useActiveWorkspaceId();
  return /* @__PURE__ */ jsx("div", { className: "add-workspace mb-4 px-4 text-center w-1/5", children: /* @__PURE__ */ jsxs(
    Button,
    {
      onClick: async (e) => {
        e.preventDefault();
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "text-left w-full", children: [
          /* @__PURE__ */ jsx("div", { className: "text-xl font-semibold", children: "+ Add New" }),
          /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold mt-1", children: "Workspace" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "absolute top-30 right-8", children: /* @__PURE__ */ jsxs("svg", { width: "92", height: "45", viewBox: "0 0 92 45", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
          /* @__PURE__ */ jsx("path", { d: "M2 42.2949C2 42.2949 8.27975 -5.21045 24 16.7949C39.7203 38.8003 46 37.7896 52 20.7949C59.4168 -0.212582 86.758 17.8755 89.5 2.79492", stroke: "url(#paint0_linear_26_2666)", "stroke-width": "4", "stroke-linecap": "round", "stroke-linejoin": "round" }),
          /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "paint0_linear_26_2666", x1: "-1.50002", y1: "47.2949", x2: "70.5778", y2: "-16.1194", gradientUnits: "userSpaceOnUse", children: [
...
function WorkspaceItem({
  ...
  const creationDate = workspace.created_at ? new Date(workspace.created_at) : /* @__PURE__ */ new Date();
  const formattedTime = creationDate instanceof Date && !isNaN(creationDate.getTime()) ? creationDate.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : "Invalid time";
  const formattedDate = creationDate instanceof Date && !isNaN(creationDate.getTime()) ? creationDate.toLocaleDateString() : "Invalid date";
  return /* @__PURE__ */ jsxs(
    "div",
    {
      onClick: () => {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "w-40 py-2 px-8 bg-gray-100 rounded-2xl flex items-center justify-center", children: /* @__PURE__ */ jsx(
          "svg",
          {
            width: "40",
            height: "40",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-auto", children: [
          /* @__PURE__ */ jsx("div", { className: clsx("text-lg font-semibold text-gray-900"), children: workspace.name || "Project 29" }),
          /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-300 dark:text-white", children: [
            formattedDate,
            " ",
            formattedTime
          ] })
  ...
  return /* @__PURE__ */ jsxs(MenuTrigger, { onItemSelected: () => setSelectorIsOpen(false), children: [
    /* @__PURE__ */ jsx(
      Button,
      {
        ...
        size: "xs",
        variant: "outline",
        endIcon: /* @__PURE__ */ jsx(KeyboardArrowDownIcon, { className: "h-40 hover:bg-transparent" }),
    ...
    switch (e.key) {
      ...
      case "ArrowLeft":
        ...
        if (isExpanded) {
          ...
          const parentEl = (_b = (_a = document.activeElement) == null ? void 0 : _a.parentElement) == null ? void 0 : _b.closest("[tabindex]");
          if (parentEl) {
            parentEl.focus();
          }
        }
...
function SidebarMenu() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "container", children: /* @__PURE__ */ jsxs("div", { className: "text-muted mt-26 px-12", children: [
...
function Sidebar({ className, logocolor }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsx("div", { className: "lg:hidden fixed top-4 left-4 z-50", children: /* @__PURE__ */ jsx("button", { onClick: toggleSidebar, "aria-label": "Toggle Sidebar", children: /* @__PURE__ */ jsx(MenuIcon, { className: "text-gray-700 dark:text-gray-300" }) }) }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: clsx(
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "sticky bottom-0 mt-20 flex items-center justify-center", children: /* @__PURE__ */ jsx(Logo, { isDarkMode, color, logoColor: logocolor }) }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsx(SidebarMenu, {}) }),
          /* @__PURE__ */ jsxs("div", { className: "mb-20 ml-4 w-200 bg-white dark:bg-gray-300 rounded-2xl shadow-lg", children: [
            /* @__PURE__ */ jsx(StorageMeter, {}),
            billing.enable ? /* @__PURE__ */ jsx("div", { className: "mt-14 mb-20 pl-20", children: /* @__PURE__ */ jsx(
              Button,
              {
                elementType: Link,
...
const setActiveFolder = (response) => {
  ...
  (!currentPage.folder || !shallowEqual(newFolder.permissions, (_a = currentPage.folder) == null ? void 0 : _a.permissions))) {
...
function usePaginatedEntries() {
  ...
  useEffect(() => {
    var _a;
    if ((_a = query.data) == null ? void 0 : _a.pages[0].folder) {
...
function useMouseSelectable(options) {
  ...
  useLayoutEffect(() => {
    ...
    mouseSelectables.set(id, {
      ...
      onSelected: () => {
        var _a, _b;
        (_b = (_a = optionsRef.current).onSelected) == null ? void 0 : _b.call(_a);
      },
      onDeselected: () => {
        var _a, _b;
        return (_b = (_a = optionsRef.current).onDeselected) == null ? void 0 : _b.call(_a);
      }
    });
    return () => {
...
function useMouseSelectionBox({ onPointerDown, ...props } = {}) {
  ...
  const drawSelectionBox = () => {
    ...
    const currentScrollTop = ((_a = containerRef.current) == null ? void 0 : _a.scrollTop) || 0;
    const newRect = {
    ...
    for (const [, selectable] of mouseSelectables) {
      ...
      if (intersect && !((_b = state.selectedIds) == null ? void 0 : _b.has(selectable.id))) {
    ...
    onMoveStart: (e) => {
      ...
      state.scrollListener = (e2) => {
        ...
        if (!state.startPoint)
          return;
        updateRects(mouseSelectables);
        if ((_a = state.boundaryRect) == null ? void 0 : _a.height) {
...
function DriveContextMenu() {
  ...
  if (((_a = data == null ? void 0 : data.entry) == null ? void 0 : _a.id) === 0) {
...
function useRootItem() {
  ...
  if (workspace && !workspace.default) {
    if ((page == null ? void 0 : page.isFolderPage) && ((page == null ? void 0 : page.id) === RootFolderPage.id || ((_a = page.folder) == null ? void 0 : _a.workspace_id) === workspace.id)) {
      return { label: workspace.name, page: RootFolderPage };
    }
  }
  if (page == null ? void 0 : page.isFolderPage) {
    const owner = (_b = page.folder) == null ? void 0 : _b.users.find((u) => u.owns_entry);
...
function Toolbar() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "my-10 flex min-h-42 items-center justify-between gap-40 px-10 text-muted md:px-18", children: [
    ...
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(CreateNewButton, { className: "px-8 text-center" }) })
  ] });
}
...
function TagChipField({ entry }) {
  ...
  return /* @__PURE__ */ jsx(
    ChipField,
    {
      ...
      children: data == null ? void 0 : data.results.map((result) => /* @__PURE__ */ jsx(Item, { value: result, children: result.name }, result.id))
    }
  );
}
...
function RenameEntryDialog({ entries }) {
  ...
  const initialName = (_a = entries[0]) == null ? void 0 : _a.name;
...
function EntryPreviewDialog({ selectedEntry }) {
  ...
  const filePermission = (_c = (_b = (_a = selectedEntry == null ? void 0 : selectedEntry.users) == null ? void 0 : _a[1]) == null ? void 0 : _b.entry_permissions) == null ? void 0 : _c.download;
  const allowDownload = !!filePermission;
  return /* @__PURE__ */ jsx(
    FilePreviewDialog,
    {
      allowDownload,
  ...
  return useMutation({
    ...
    onError: (err) => {
      ...
      if (axios.isAxiosError(err) && err.response) {
        ...
        if ((_a = response.errors) == null ? void 0 : _a.emails) {
          toast.danger((_b = response.errors) == null ? void 0 : _b.emails[0]);
        } else {
  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    /* @__PURE__ */ jsx(
      ChipField,
      {
        ...
        inputValue,
        onInputValueChange: setInputValue,
        suggestions: (_a = query.data) == null ? void 0 : _a.results,
        displayWith,
        validateWith: (chip) => {
          const invalid = !isEmail(chip.description);
          return {
...
function ShareableLinkPanel({
  ...
  const linkExists = !!((_a = query.data) == null ? void 0 : _a.link);
  const createLink = useCreateShareableLink();
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between gap-14 px-2 pb-4", children: /* @__PURE__ */ jsx(
      Switch,
      {
        checked: linkExists,
        disabled: isLoading,
    ...
    /* @__PURE__ */ jsx(ShareableLinkInput, { autoFocus: focusInput, link: (_b = query.data) == null ? void 0 : _b.link })
  ] });
}
...
function getDialog(dialog) {
  ...
  switch (dialog == null ? void 0 : dialog.name) {
    ...
    case "newFolder":
      return /* @__PURE__ */ jsx(NewFolderDialog, { parentId: (_a = dialog.entries[0]) == null ? void 0 : _a.id });
    case "preview":
...
const EntryPreview = memo(
  ({ entry, points, index, state }) => {
    ...
    const itemCount = ((_a = state.entries) == null ? void 0 : _a.length) || 0;
    const exitVariant = (status) => {
      ...
      return {
        x: rect.left - (((_a2 = points.end) == null ? void 0 : _a2.x) || 0),
        y: rect.top - (((_b2 = points.end) == null ? void 0 : _b2.y) || 0),
    ...
    return /* @__PURE__ */ jsxs(
      m.div,
      {
        ...
        initial: {
          ...
          width: `${(_b = state.e) == null ? void 0 : _b.rect.width}px`
        },
        animate: {
          x: 0,
          y: 0,
...
function DriveContentHeader() {
  const { isMobileMode } = useContext(DashboardLayoutContext);
  const activePage = useDriveStore((s) => s.activePage);
  return /* @__PURE__ */ jsxs(DashboardContentHeader, { className: "px-8 md:px-26 py-4 mt-20 flex items-center gap-20 h-60", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
    /* @__PURE__ */ jsx(Tooltip, { label: /* @__PURE__ */ jsx(Trans, { message: "Grid view" }), children: /* @__PURE__ */ jsx(
      IconButton,
      {
        ...
        children: /* @__PURE__ */ jsx(ViewModuleIcon, {})
      }
    ) }),
    /* @__PURE__ */ jsx(Tooltip, { label: /* @__PURE__ */ jsx(Trans, { message: "List view" }), children: /* @__PURE__ */ jsx(
      IconButton,
      {
        ...
        children: /* @__PURE__ */ jsx(ViewListIcon, {})
      }
    ) })
  ] });
}
...
function WorkspaceContentHeader() {
  useContext(DashboardLayoutContext);
  useDriveStore((s) => s.activePage);
  return /* @__PURE__ */ jsxs(DashboardContentHeader, { className: "px-8 md:px-26 py-4 mt-20 flex items-center gap-20 h-60", children: [
    /* @__PURE__ */ jsx("li", { className: "relative inline-flex min-w-0 flex-shrink-0 items-center justify-start text-lg", children: /* @__PURE__ */ jsx("div", { className: "ml-16 cursor-pointer overflow-hidden whitespace-nowrap rounded px-8 py-4 font-semibold text-bg-600 hover:bg-hover", children: "Workspace" }) }),
    ...
    /* @__PURE__ */ jsx(FileUploadProvider, { children: /* @__PURE__ */ jsxs(
      DashboardLayout,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Navbar, {}),
          /* @__PURE__ */ jsx(DashboardSidenav, { position: "left", size: "md", children: /* @__PURE__ */ jsx(Sidebar, {}) }),
          /* @__PURE__ */ jsx(WorkspaceContentHeader, {}),
          /* @__PURE__ */ jsx(WorkspaceSelector, {})
        ]
      }
    ) })
  ] });
...
const DriveRouteConfig = [
  ...
  {
    path: "/workspace",
    element: /* @__PURE__ */ jsx(AuthRoute, { children: /* @__PURE__ */ jsx(WorkspaceLayout, {}) })
  },
  // {
  //   path: '/supportticket',
  //   element: (
...
//# sourceMappingURL=drive-routes-31c4ba6b.mjs.map
