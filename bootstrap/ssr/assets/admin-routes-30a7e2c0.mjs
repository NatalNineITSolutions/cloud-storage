...
const IconList = React.lazy(() => import("./icon-list-dc5f0e84.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-71d9c172.mjs"));
...
//# sourceMappingURL=admin-routes-30a7e2c0.mjs.map
