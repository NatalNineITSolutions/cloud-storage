...
import { u as useSettings, C as CustomMenu, T as Trans, D as DashboardLayout, a as DashboardNavbar, b as DashboardSidenav, m as message, c as apiClient, d as useIsMobileMediaQuery, e as useNumberFormatter, I as Item, f as IconButton, g as createSvgIcon, h as useDialogContext, i as Dialog, j as DialogHeader, k as DialogBody, F as Form$1, l as Checkbox, B as Button, n as DialogTrigger, o as useTrans, p as TextField, S as SearchIcon, q as opacityAnimation, r as Skeleton, P as ProgressBar, s as StaticPageTitle, t as queryClient, v as toast, w as showHttpErrorToast, x as ConfirmationDialog, y as IllustratedMessage, z as SvgImage, A as AddIcon, E as DialogFooter, G as onFormQueryError, H as FormTextField, J as CheckIcon, K as CloseIcon, L as Chip, M as FormattedDate, N as Tooltip, O as useAuth, Q as MixedText, R as FileUploadProvider, U as useAppearanceEditorMode, V as ProgressCircle, W as ButtonBase, X as useValueLists, Y as List, Z as ListItem, _ as clamp, $ as createSvgIconFromTree, a0 as DoneAllIcon, a1 as Section, a2 as useNavigate$1, a3 as FormImageSelector, a4 as useBootstrapData, a5 as LinkStyle, a6 as SiteConfigContext, a7 as getBootstrapData, a8 as MenuTrigger, a9 as Menu, aa as getInputFieldClassNames, ab as FormRadioGroup, ac as FormRadio, ad as prettyBytes, ae as useSocialLogin, af as ExternalLink, ag as useField, ah as Field, ai as useResendVerificationEmail, aj as useUser, ak as FullPageLoader, al as useUploadAvatar, am as useRemoveAvatar, an as FileTypeIcon, ao as useProducts, ap as FormattedPrice, aq as useActiveUpload, ar as UploadInputType, as as Disk, at as WarningIcon, au as KeyboardArrowDownIcon, av as useCustomPage, aw as PageMetaTags, ax as PageStatus, ay as useCollator, az as loadFonts, aA as AuthRoute, aB as NotFoundPage } from "../server-entry.mjs";
import { D as DashboardContent, F as FilterOperator, a as FilterControlType, c as createdAtFilter, u as updatedAtFilter, S as SelectForwardRef, K as KeyboardArrowLeftIcon, b as KeyboardArrowRightIcon, A as ArrowDropDownIcon, d as useBackendFilterUrlParams, I as InputFilterPanel, N as NormalizedModelFilterPanel, e as DateRangeFilterPanel, C as ChipFieldFilterPanel, f as SelectFilterPanel, B as BackendFiltersUrlKey, g as FilterList$1, T as Table, h as downloadFileFromUrl, i as FileDownloadIcon, j as Avatar, k as FormDatePicker, l as FormSwitch, m as ChipList, n as useDraggable, o as useDroppable, p as updateRects, q as droppables, r as FormChipField, s as DeleteIcon, t as Switch, v as FormSelect, U as USER_MODEL, M as MoreVertIcon, w as ChipField, x as useNormalizedModels, y as FILE_ENTRY_INDEX_FILTERS, z as FilePreviewDialog, E as timestampFilter, G as FormNormalizedModelField, L as LinkIcon, H as ArrowBackIcon } from "./ArrowBack-ac331367.mjs";
import React, { useContext, isValidElement, cloneElement, useRef, useId, useState, Fragment, useEffect, forwardRef, useMemo, Suspense, Children, useCallback, memo } from "react";
import { useQuery, keepPreviousData, useMutation, useQueryClient } from "@tanstack/react-query";
import { AnimatePresence, m } from "framer-motion";
import { useControlledState } from "@react-stately/utils";
import { FocusScope, useFocusManager, getFocusableTreeWalker } from "@react-aria/focus";
import { useForm, useFormContext, useFieldArray, useController, FormProvider } from "react-hook-form";
import { E as EditIcon, B as Breadcrumb, a as BreadcrumbItem } from "./Edit-19a60eb6.mjs";
import { create } from "zustand";
import { subscribeWithSelector } from "zustand/middleware";
import { immer } from "zustand/middleware/immer";
import deepMerge from "deepmerge";
import { nanoid } from "nanoid";
import { mergeProps, getScrollParent, useLayoutEffect, useObjectRef, isMac } from "@react-aria/utils";
...
import { u as useCancelSubscription, a as useResumeSubscription } from "./use-resume-subscription-8a9e2163.mjs";
...
const userDatatableColumns = [
  ...
  },
  {
    ...
    body: (user) => {
      var _a;
      return ((_a = user.subscriptions) == null ? void 0 : _a.length) ? /* @__PURE__ */ jsx(CheckIcon, { className: "text-positive icon-md" }) : /* @__PURE__ */ jsx(CloseIcon, { className: "text-danger icon-md" });
    }
  },
  {
    key: "roles",
...
function UserDatatable() {
  ...
  const isSuperAdmin = (user == null ? void 0 : user.user_type) === "super_admin" || false;
  const queryParams = isSuperAdmin ? { with: "subscriptions,bans", admin_user_id: userId } : { admin_user_id: userId };
  ...
  sections: {
    ...
    themes: {
      ...
      buildBreadcrumb: (pathname, formValue) => {
        ...
        if (themeIndex != null) {
          breadcrumb.push({
            label: (_a = formValue.appearance.themes.all[+themeIndex]) == null ? void 0 : _a.name,
      ...
      buildBreadcrumb: (pathname, formValue) => {
        ...
        chunked.forEach(([sectionName, sectionIndex], chunkIndex) => {
          ...
          if (sectionName === "menus" && sectionIndex != null) {
            breadcrumb.push({
              label: (_a = formValue.settings.menus[+sectionIndex]) == null ? void 0 : _a.name,
    ...
    immer((set, get) => ({
      ...
      preview: {
        navigate: (sectionName) => {
          var _a;
          const section = (_a = get().config) == null ? void 0 : _a.sections[sectionName];
        ...
        setHighlight: (selector) => {
          set(() => {
            var _a;
            let node = null;
            const document = (_a = get().iframeWindow) == null ? void 0 : _a.document;
...
function SectionHeader() {
  ...
  useEffect(() => {
    ...
    if (sectionName) {
      const section = (_a = appearanceState().config) == null ? void 0 : _a.sections[sectionName];
      if (section) {
        setBreadcrumb([
          {
...
function MenuEditorSection({ formPath }) {
  ...
  const menuSectionConfig = useAppearanceStore(
    (s) => {
      var _a;
      return (_a = s.config) == null ? void 0 : _a.sections.menus.config;
    }
  );
...
function Restrictions({ permission, onChange }) {
  var _a;
  if (!((_a = permission == null ? void 0 : permission.restrictions) == null ? void 0 : _a.length))
    return null;
...
const IconList = React.lazy(() => import("./icon-list-1b7e27ea.mjs"));
...
function RoleSelector({ prefixName }) {
  ...
  return /* @__PURE__ */ jsx(
    FormChipField,
    {
      ...
      displayWith: (c) => {
        var _a;
        return (_a = roles.find((r) => r.id === c.id)) == null ? void 0 : _a.name;
      },
...
function BrandingImageSelector({ label, description, type }) {
  const defaultValue = useAppearanceStore(
    (s) => {
      var _a;
      return (_a = s.defaults) == null ? void 0 : _a.settings.branding[type];
    }
  );
  return /* @__PURE__ */ jsx(
    FormImageSelector,
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "mb-20", children: /* @__PURE__ */ jsx(
      Button,
      {
        ...
        onClick: () => {
          var _a;
          const lightThemeColors = (_a = appearanceState().defaults) == null ? void 0 : _a.appearance.themes.light;
          append({
            id: randomNumber(),
...
const AceEditor = React.lazy(() => import("./ace-editor-bf25d9e2.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
const UserAdminSettingsNavConfig = [
  { label: message("Uploading"), to: "uploading" }
].filter(Boolean);
const SettingsNavConfig = filteredSettingsNavConfig;
const userAdminNavConfig = UserAdminSettingsNavConfig;
...
function MobileNav() {
  ...
  return /* @__PURE__ */ jsx(
    SelectForwardRef,
    {
      ...
      children: sideNavbar.map((item) => /* @__PURE__ */ jsx(Item, { value: item.to, children: /* @__PURE__ */ jsx(Trans, { ...item.label }) }, item.to))
    }
  );
}
function DesktopNav() {
  ...
  const isSuperAdmin = (user == null ? void 0 : user.user_type) === "super_admin";
  const sideNavbar = isSuperAdmin ? SettingsNavConfig : userAdminNavConfig || [];
  return /* @__PURE__ */ jsx("div", { className: "sticky top-24 w-240 flex-shrink-0", children: sideNavbar.map((item) => /* @__PURE__ */ jsx(
    NavLink,
    {
      to: item.to,
...
function useUpdateAdminSettings(form) {
  ...
  return useMutation({
    mutationFn: (props) => {
      ...
      if ((_b = (_a = props.client) == null ? void 0 : _a.cookie_notice) == null ? void 0 : _b.button) {
...
function LearnMoreLink({ link, className }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: clsx("flex items-center gap-8", className) });
}
function GeneralSettings() {
  return /* @__PURE__ */ jsx(
    SettingsPanel,
    {
      ...
      children: /* @__PURE__ */ jsx(SiteUrlSection, {})
    }
  );
}
...
function NavbarColorPicker() {
  ...
  const previewColor = (_a = navbarColorMap.find(({ value }) => value === selectedValue)) == null ? void 0 : _a.previewBgColor;
  return /* @__PURE__ */ jsxs(
    MenuTrigger,
    {
      placement: "right",
  ...
  return /* @__PURE__ */ jsx(
    SettingsPanel,
    {
      ...
      children: /* @__PURE__ */ jsxs(Tabs, { children: [
        /* @__PURE__ */ jsx(TabList, { children: /* @__PURE__ */ jsx(Tab, { children: /* @__PURE__ */ jsx(Trans, { message: "General" }) }) }),
        /* @__PURE__ */ jsx(TabPanels, { className: "pt-30", children: /* @__PURE__ */ jsxs(TabPanel, { children: [
          /* @__PURE__ */ jsx(
            FormSwitch,
            {
...
function AuthenticationSettings() {
  return /* @__PURE__ */ jsx(
    SettingsPanel,
    {
      ...
      children: /* @__PURE__ */ jsx(EmailConfirmationSection, {})
    }
  );
}
  ...
  return /* @__PURE__ */ jsxs(
    SettingsPanel,
    {
      ...
      children: [
        ...
        isSuperAdmin && /* @__PURE__ */ jsx(SettingsErrorGroup, { name: "static_delivery_group", children: (isInvalid) => /* @__PURE__ */ jsxs(
          FormRadioGroup,
          {
            invalid: isInvalid,
            size: "sm",
        ...
        isSuperAdmin && /* @__PURE__ */ jsx(MaxUploadSizeSection, {}),
        isSuperAdmin && /* @__PURE__ */ jsx(SettingsSeparator, {}),
        isSuperAdmin && /* @__PURE__ */ jsx(
          FormFileSizeField,
          {
            min: 1,
...
function S3DirectUploadField({ invalid }) {
  ...
  const s3DriverEnabled = ((_a = defaultSettings == null ? void 0 : defaultSettings.server.uploads_disk_driver) == null ? void 0 : _a.endsWith("s3")) || ((_b = defaultSettings == null ? void 0 : defaultSettings.server.public_disk_driver) == null ? void 0 : _b.endsWith("s3"));
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      FormSwitch,
      {
...
function FormFileField({ name, ...props }) {
  ...
  const formProps = {
    onChange: (e) => {
      var _a;
      onChange((_a = e.target.files) == null ? void 0 : _a[0]);
      setValue(e.target.value);
    },
    onBlur,
    value,
...
function UpdateUserPage() {
  ...
  const banReason = (_b = (_a = data == null ? void 0 : data.user.bans) == null ? void 0 : _a[0]) == null ? void 0 : _b.comment;
  useEffect(() => {
...
function AdsPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "container mx-auto p-12 md:p-24", children: [
    ...
    query.isLoading ? /* @__PURE__ */ jsx(ProgressCircle, { isIndeterminate: true }) : /* @__PURE__ */ jsx(AdsForm, { defaultValues: ((_a = query.data) == null ? void 0 : _a.client.ads) || {} })
  ] });
}
...
function SectionList() {
  const sections = useAppearanceStore((s) => {
    var _a;
    return (_a = s.config) == null ? void 0 : _a.sections;
  });
...
function SelectUserDialog({ onUserSelected }) {
  ...
  const users = ((_a = query.data) == null ? void 0 : _a.results) || [];
...
const softwareEngineerSvg = "/assets/software-engineer-e3b0c442.svg";
function CreateTagDialog() {
  ...
  return /* @__PURE__ */ jsx(Dialog, { children: /* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(Trans, { message: "Add new tag" }) }) });
}
...
function UpdateTagDialog({ tag }) {
  ...
  return /* @__PURE__ */ jsx(Dialog, { children: /* @__PURE__ */ jsx(DialogBody, { children: /* @__PURE__ */ jsx(
    CrupdateTagForm,
    {
      formId,
      form,
...
const columnConfig$2 = [
  ...
  },
  {
    ...
    body: (entry) => {
      var _a;
      const user = (_a = entry.users) == null ? void 0 : _a[0];
      if (!user)
        return null;
      return /* @__PURE__ */ jsx(
        NameWithAvatar,
...
function CrupdateSubscriptionForm({
  ...
  const selectedProduct = (_a = query.data) == null ? void 0 : _a.products.find(
...
const columnConfig$1 = [
  ...
  },
  {
    ...
    body: (subscription) => {
      var _a;
      return (_a = subscription.product) == null ? void 0 : _a.name;
    }
  },
  {
    key: "gateway_name",
...
function PriceForm({ index, onRemovePrice }) {
  ...
  const currencies = useMemo(() => {
    var _a;
    return ((_a = query.data) == null ? void 0 : _a.currencies) ? Object.values(query.data.currencies) : [];
  }, [query.data]);
...
function PricingListForm() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    ((_a = errors.prices) == null ? void 0 : _a.message) && /* @__PURE__ */ jsx("div", { className: "text-sm text-danger mb-20", children: errors.prices.message }),
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-031880e8.mjs")
);
...
function useFontSelectorState({
  ...
  const filteredFonts = useMemo(() => {
    return allFonts.filter((font) => {
      var _a;
      return contains(font.family, filters.query) && (!filters.category || ((_a = font.category) == null ? void 0 : _a.toLowerCase()) === filters.category.toLowerCase());
    });
...
const ReportsPage = React.lazy(() => import("./admin-report-page-3c0ee3b7.mjs"));
  ...
  },
  {
    ...
    children: [
      ...
      // SETTINGS
      {
        ...
        children: [
          { index: true, element: /* @__PURE__ */ jsx(Navigate, { to: "uploading", replace: true }) },
...
//# sourceMappingURL=admin-routes-e9b7e0a0.mjs.map
