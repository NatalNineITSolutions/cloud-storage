...
import { q as queryClient, az as getFromLocalStorage, aA as setInLocalStorage, a4 as getBootstrapData, a as apiClient, s as showHttpErrorToast, m as message, t as toast, L as useAuth, a5 as MenuTrigger, d as IconButton, ar as KeyboardArrowDownIcon, a6 as Menu, I as Item, T as Trans, K as Tooltip, B as Button, b as useIsMobileMediaQuery, aB as Navbar$1, ak as FileTypeIcon, k as useTrans, w as SvgImage, aC as secureFilesSvg, l as TextField, aD as getAxiosErrorMessage, aa as prettyBytes, aE as useFileUploadStore, u as useSettings, aF as getActiveWorkspaceId, aG as UploadedFile, aH as openUploadWindow, J as FormattedDate, i as Checkbox, Q as ProgressCircle, aI as AdHost, o as opacityAnimation, j as DialogTrigger, _ as Section, N as FileUploadProvider, v as IllustratedMessage, ay as NotFoundPage, aJ as ProgressBarBase, aK as WorkspaceQueryKeys, y as onFormQueryError, f as useDialogContext, D as Dialog, g as DialogHeader, h as DialogBody, F as Form, z as FormTextField, x as DialogFooter, aL as useActiveWorkspaceId, aM as PersonalWorkspace, r as ConfirmationDialog, U as useValueLists, aN as ExitToAppIcon, G as CloseIcon, A as ArrowDropDownIcon, aO as useUserWorkspaces, R as ButtonBase, aP as openDialog, E as CheckIcon, aQ as createEventHandler, $ as useNavigate$1, aR as CustomMenuItem, C as CustomMenu, aS as shallowEqual, S as SearchIcon, aT as ContextMenu, aU as useMediaQuery, aV as useActiveWorkspace, M as MixedText, aW as ErrorIcon, aq as WarningIcon, aX as CheckCircleIcon, a3 as SiteConfigContext, aY as useListbox, aZ as Listbox, a_ as Popover, a$ as useListboxKeyboardNavigation, V as List, W as ListItem, p as StaticPageTitle, ax as AuthRoute } from "../server-entry.mjs";
import { create } from "zustand";
import { immer } from "zustand/middleware/immer";
import React, { Fragment, useState, useCallback, createElement, useContext, useRef, useEffect, cloneElement, createContext, forwardRef, useMemo, useLayoutEffect, memo, useId } from "react";
import { R as useFileEntryUrls, k as downloadFileFromUrl, l as FileDownloadIcon, V as FileThumbnail, O as LinkIcon, w as DeleteIcon, W as TableContext, M as MoreVertIcon, T as Table, H as FilePreviewDialog, D as DashboardLayout, a as DashboardNavbar, c as DashboardContent, X as FilePreviewContainer, Y as FileEntryUrlsContext, z as ChipField, P as UnfoldMoreIcon, A as AddIcon, r as useDroppable, q as useDraggable, Z as FILE_ENTRY_TYPE_FILTER, F as FilterOperator, d as FilterControlType, e as createdAtFilter, u as updatedAtFilter, _ as DashboardLayoutContext, j as FilterList, t as droppables, $ as usePointerEvents, s as updateRects, a0 as activeInteraction, a1 as isCtrlOrShiftPressed, a2 as isCtrlKeyPressed, m as Avatar, E as useNormalizedModels, x as Switch, o as FormSwitch, n as FormDatePicker, a3 as ComboboxEndAdornment, Q as ArrowBackIcon, a4 as dragMonitors, b as DashboardSidenav } from "./UnfoldMore-c8b36b6f.mjs";
...
import { B as Breadcrumb, a as BreadcrumbItem, E as EditIcon, C as ChevronRightIcon } from "./Edit-38f70f4d.mjs";
    ...
    ButtonBase,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("span", { className: "mr-auto block flex-auto overflow-hidden text-left", children: [
          /* @__PURE__ */ jsx("span", { className: "block overflow-hidden overflow-ellipsis text-sm font-medium text-main", children: activeWorkspace.default ? /* @__PURE__ */ jsx(Trans, { message: activeWorkspace.name }) : activeWorkspace.name }),
          /* @__PURE__ */ jsx("span", { className: "block text-xs text-muted", children: activeWorkspace.default ? /* @__PURE__ */ jsx(Trans, { message: "Personal workspace" }) : /* @__PURE__ */ jsx(
            Trans,
            {
          ...
          /* @__PURE__ */ jsx("div", { className: "mb-4 px-4 text-center", children: /* @__PURE__ */ jsx(
            Button,
            {
              onClick: async (e) => {
                ...
                e.stopPropagation();
                setSelectorIsOpen(false);
                const workspaceId2 = await openDialog(NewWorkspaceDialog);
                if (workspaceId2) {
                  setWorkspaceId(workspaceId2);
                  onChange == null ? void 0 : onChange(workspaceId2);
                }
              },
              variant: "outline",
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "sticky bottom-0 mt-40", children: /* @__PURE__ */ jsx(WorkspaceSwitcher, {}) })
      ]
    }
  );
}
...
function EntryPreviewDialog({ selectedEntry }) {
  ...
  const filePermission = (_c = (_b2 = (_a2 = selectedEntry == null ? void 0 : selectedEntry.users) == null ? void 0 : _a2[1]) == null ? void 0 : _b2.entry_permissions) == null ? void 0 : _c.download;
...
//# sourceMappingURL=drive-routes-bb9dd678.mjs.map
